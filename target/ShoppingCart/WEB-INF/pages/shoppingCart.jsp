...
<%--                         <li>Subtotal:
                        ...
                        <li><a
                            href="${pageContext.request.contextPath}/shoppingCartRemoveProduct?code=${cartLineInfo.product.code}">
                                Delete </a></li>
                    </ul>
                </div>
            </c:forEach>
            ...
            <a class="navi-item"
                ...
                Buy</a>
                	|	
            <a class="navi-item"
                href="${pageContext.request.contextPath}/shoppingCartConfirmation">Finilize Cart</a>
            </form:form>
    </c:if>
</body>
</html>